...
# Solana Peg-Risk Skill Installer for Claude Code
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --path)
            ...
            ;;
        -h|--help)
            echo "Solana Peg-Risk Skill Installer"
            echo ""
...
# Copy skill files
echo "Installing Solana Peg-Risk Skill..."
cp -r "$SOURCE_DIR" "$INSTALL_PATH"

# Make any executable scripts executable
...
echo "Try: /peg-assess <mint>  or ask about collateral safety for USDC, jitoSOL, hyUSD..."
